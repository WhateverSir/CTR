...
if __version__ == 'tensorflow':
    ...
    from openctr.tensorflow.models import WideDeep
    from openctr.tensorflow.utils import seed_everything
elif __version__ == 'pytorch':
    from openctr.pytorch.models import WideDeep
...
#              'gpu': __gpu__}
    ...
    model = WideDeep(feature_encoder, **params)
