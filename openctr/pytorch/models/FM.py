...
class FM(BaseModel):
    def __init__(self, feature_encoder, model_id='FM', gpu=-1, task='classification', 
                 ...
                 embedding_dim=10, embedding_regularizer=None, kernel_regularizer=None, **kwargs):
        super(FM, self).__init__(feature_encoder, model_id=model_id, gpu=gpu, 
                                 embedding_regularizer=embedding_regularizer, kernel_regularizer=kernel_regularizer,
                                 **kwargs)
