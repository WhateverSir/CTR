#loc = loc(unknown)
module attributes {module.FLOPs = 1825649 : i64, module.chip = "ALL", module.name = "DeepFM", module.platform = "ONNX", module.state = "TOP_F32", module.weight_file = "deepfm_top_f32_all_weight.npz"} {
  func.func @main(%arg0: tensor<1x5xf32> loc(unknown)) -> tensor<1x1xf32> {
    ...
    %37 = "top.Concat"(%32, %33, %34, %35, %36) {axis = 0 : si32, do_relu = false, relu_limit = -1.000000e+00 : f64} : (tensor<1x1x1xf32>, tensor<1x1x1xf32>, tensor<1x1x1xf32>, tensor<1x1x1xf32>, tensor<1x1x1xf32>) -> tensor<5x1x1xf32> loc(#loc37)
    ...
    %44 = "top.Concat"(%39, %40, %41, %42, %43) {axis = 0 : si32, do_relu = false, relu_limit = -1.000000e+00 : f64} : (tensor<1x1x64xf32>, tensor<1x1x64xf32>, tensor<1x1x64xf32>, tensor<1x1x64xf32>, tensor<1x1x64xf32>) -> tensor<5x1x64xf32> loc(#loc44)
    %45 = "top.Reduce"(%44) {axes = [0], keepdims = false, mode = "ReduceSum"} : (tensor<5x1x64xf32>) -> tensor<1x64xf32> loc(#loc45)
    %46 = "top.Mul"(%45, %45) {do_relu = false, relu_limit = -1.000000e+00 : f64} : (tensor<1x64xf32>, tensor<1x64xf32>) -> tensor<1x64xf32> loc(#loc46)
    %47 = "top.Mul"(%44, %44) {do_relu = false, relu_limit = -1.000000e+00 : f64} : (tensor<5x1x64xf32>, tensor<5x1x64xf32>) -> tensor<5x1x64xf32> loc(#loc47)
    %48 = "top.Reduce"(%47) {axes = [0], keepdims = false, mode = "ReduceSum"} : (tensor<5x1x64xf32>) -> tensor<1x64xf32> loc(#loc48)
    %49 = "top.Sub"(%46, %48) {do_relu = false, is_reverse = false, relu_limit = -1.000000e+00 : f64} : (tensor<1x64xf32>, tensor<1x64xf32>) -> tensor<1x64xf32> loc(#loc49)
    %50 = "top.MulConst"(%49) {const_val = 5.000000e-01 : f64, do_relu = false, relu_limit = -1.000000e+00 : f64} : (tensor<1x64xf32>) -> tensor<1x64xf32> loc(#loc50)
    ...
    %53 = "top.Add"(%38, %52) {do_relu = false, relu_limit = -1.000000e+00 : f64} : (tensor<1x1xf32>, tensor<1x1xf32>) -> tensor<1x1xf32> loc(#loc53)
    %54 = "top.Concat"(%5, %9, %13, %17, %21) {axis = 1 : si32, do_relu = false, relu_limit = -1.000000e+00 : f64} : (tensor<1x64xf32>, tensor<1x64xf32>, tensor<1x64xf32>, tensor<1x64xf32>, tensor<1x64xf32>) -> tensor<1x320xf32> loc(#loc54)
    %55 = "top.Weight"() : () -> tensor<320x500xf32> loc(#loc55)
    %56 = "top.Weight"() : () -> tensor<500xf32> loc(#loc56)
    %57 = "top.MatMul"(%54, %55, %56) {do_relu = true, hdim_is_batch = false, keep_dims = true, left_transpose = false, output_transpose = false, relu_limit = -1.000000e+00 : f64, right_transpose = false} : (tensor<1x320xf32>, tensor<320x500xf32>, tensor<500xf32>) -> tensor<1x500xf32> loc(#loc57)
    %58 = "top.Weight"() : () -> tensor<500x500xf32> loc(#loc58)
    %59 = "top.Weight"() : () -> tensor<500xf32> loc(#loc59)
    %60 = "top.MatMul"(%57, %58, %59) {do_relu = true, hdim_is_batch = false, keep_dims = true, left_transpose = false, output_transpose = false, relu_limit = -1.000000e+00 : f64, right_transpose = false} : (tensor<1x500xf32>, tensor<500x500xf32>, tensor<500xf32>) -> tensor<1x500xf32> loc(#loc60)
    %61 = "top.Weight"() : () -> tensor<500x500xf32> loc(#loc61)
    %62 = "top.Weight"() : () -> tensor<500xf32> loc(#loc62)
    %63 = "top.MatMul"(%60, %61, %62) {do_relu = true, hdim_is_batch = false, keep_dims = true, left_transpose = false, output_transpose = false, relu_limit = -1.000000e+00 : f64, right_transpose = false} : (tensor<1x500xf32>, tensor<500x500xf32>, tensor<500xf32>) -> tensor<1x500xf32> loc(#loc63)
    %64 = "top.Weight"() : () -> tensor<500x500xf32> loc(#loc64)
    %65 = "top.Weight"() : () -> tensor<500xf32> loc(#loc65)
    %66 = "top.MatMul"(%63, %64, %65) {do_relu = true, hdim_is_batch = false, keep_dims = true, left_transpose = false, output_transpose = false, relu_limit = -1.000000e+00 : f64, right_transpose = false} : (tensor<1x500xf32>, tensor<500x500xf32>, tensor<500xf32>) -> tensor<1x500xf32> loc(#loc66)
    %67 = "top.Weight"() : () -> tensor<500x1xf32> loc(#loc67)
    %68 = "top.Weight"() : () -> tensor<1xf32> loc(#loc68)
    %69 = "top.MatMul"(%66, %67, %68) {do_relu = false, hdim_is_batch = false, keep_dims = true, left_transpose = false, output_transpose = false, relu_limit = -1.000000e+00 : f64, right_transpose = false} : (tensor<1x500xf32>, tensor<500x1xf32>, tensor<1xf32>) -> tensor<1x1xf32> loc(#loc69)
    %70 = "top.Add"(%53, %69) {do_relu = false, relu_limit = -1.000000e+00 : f64} : (tensor<1x1xf32>, tensor<1x1xf32>) -> tensor<1x1xf32> loc(#loc70)
    %71 = "top.Sigmoid"(%70) {bias = 0.000000e+00 : f64, log = false, scale = 1.000000e+00 : f64} : (tensor<1x1xf32>) -> tensor<1x1xf32> loc(#loc71)
    return %71 : tensor<1x1xf32> loc(#loc)
  } loc(#loc)
} loc(#loc)
#loc1 = loc("input")
